  ...
  private
    ...
    def carrier_lane_params
      if params[:carrier_lane][:lane_origin].to_s.tr('[]', '').tr('"', '')[2..-1].nil?
        ...
        params[:carrier_lane][:lane_origin] = params[:carrier_lane][:lane_origin].to_s.tr('[]', '').tr('"', '')[2..-1].gsub(', ', ',').to_s
      end
      if params[:carrier_lane][:lane_destination].to_s.tr('[]', '').tr('"', '')[2..-1].nil?
        params[:carrier_lane].delete :lane_destination
      else
