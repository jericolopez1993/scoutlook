class ShipperActivitiesController < ApplicationController
  ...
  private
    ...
    def shipper_activity_params
      ...
      params.require(:shipper_activity).permit(:date_stamp, :activity_type, :engagement_type, :shipper_id, :user_id, :annual_value, :status, :date_opened, :date_closed, :other_notes, :outcome_id, :campaign_name)
    end
