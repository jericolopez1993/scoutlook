class CarrierActivitiesController < ApplicationController
  ...
  private
    ...
    def carrier_activity_params
      ...
      params.require(:carrier_activity).permit(:date_stamp, :activity_type, :engagement_type, :carrier_id, :user_id, :annual_value, :status, :date_opened, :date_closed, :other_notes, :outcome_id, :campaign_name)
    end
