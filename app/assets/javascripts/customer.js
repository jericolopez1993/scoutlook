$(function () {
  ...
  var table = $('#customer_table').dataTable({
    ...
    // $( "#customer_table_length" ).append('<label>Search:<input type="search" class="form-control input-sm" id="filterbox" placeholder="" aria-controls="customer_table"></label>');
    ...
    //   console.log("test")
    //   $('#customer_table').DataTable().search(this.value, false, false).draw();
    // });
});
