class Shipper < ApplicationRecord
  ...
  scope :listings, -> {select("shippers.*, shipper_contacts.primary_phone, shipper_contacts.primary_phone_type, shipper_contacts.primary_extension_number, shipper_contacts.primary_eligible_texting, shipper_contacts.secondary_phone, shipper_contacts.secondary_phone_type, shipper_contacts.secondary_extension_number, shipper_contacts.secondary_eligible_texting, shipper_contacts.email as contact_email, shipper_locations.city, shipper_locations.address, shipper_locations.state, shipper_locations.country, shipper_locations.loc_type, (SELECT id FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id ORDER BY lane_priority DESC, created_at DESC LIMIT 1) AS lane_id, (SELECT lane_destination FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id ORDER BY lane_priority DESC, created_at DESC LIMIT 1) as lane_destination, (SELECT lane_origin FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id ORDER BY lane_priority DESC, created_at DESC LIMIT 1) as lane_origin, (SELECT date_opened FROM activities WHERE activities.shipper_id = shippers.id ORDER BY created_at DESC LIMIT 1) as date_opened, CONCAT(relationship_owner_user.first_name, ' ', relationship_owner_user.last_name) as relationship_owner_name, CONCAT(shipper_contacts.first_name, ' ', shipper_contacts.last_name) as pdm_name, (SELECT created_at FROM audits WHERE ((auditable_type = 'Carrier' AND auditable_id IN (shippers.id)) OR (auditable_type = 'CarrierCompany' AND auditable_id IN (SELECT id FROM shipper_companies WHERE shipper_companies.shipper_id = shippers.id)) OR (auditable_type = 'CarrierContact' AND auditable_id IN (SELECT id FROM shipper_contacts WHERE shipper_contacts.shipper_id = shippers.id)) OR (auditable_type = 'CarrierLane' AND auditable_id IN (SELECT id FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id)) OR (auditable_type = 'CarrierLocation' AND auditable_id IN (SELECT id FROM shipper_locations WHERE shipper_locations.shipper_id = shippers.id)) OR (auditable_type = 'Activity' AND auditable_id IN (SELECT id FROM activities WHERE activities.shipper_id = shippers.id)) OR (auditable_type = 'Rate' AND auditable_id IN (SELECT id FROM rates WHERE rates.shipper_id = shippers.id)) OR (auditable_type = 'Reminder' AND auditable_id IN (SELECT id FROM reminders WHERE reminders.shipper_id = shippers.id))) ORDER BY created_at DESC LIMIT 1) AS last_activity_date, (SELECT campaign_name FROM activities WHERE shipper_id =  shippers.id ORDER BY created_at DESC LIMIT 1) AS campaign_name, (SELECT activity_type FROM activities WHERE shipper_id =  shippers.id ORDER BY created_at DESC LIMIT 1) AS activity_type, (SELECT status FROM activities WHERE shipper_id =  shippers.id ORDER BY created_at DESC LIMIT 1) AS activity_status").joins("INNER JOIN users AS relationship_owner_user ON relationship_owner_user.id = shippers.relationship_owner").joins("INNER JOIN shipper_locations ON shipper_locations.id = shippers.head_office").joins("INNER JOIN shipper_contacts ON shipper_contacts.id = shippers.pdm_id")}

  scope :overall, ->(id) {where(:id => id).select("shippers.*, shipper_contacts.primary_phone, shipper_contacts.primary_phone_type, shipper_contacts.primary_extension_number, shipper_contacts.primary_eligible_texting, shipper_contacts.secondary_phone, shipper_contacts.secondary_phone_type, shipper_contacts.secondary_extension_number, shipper_contacts.secondary_eligible_texting, shipper_contacts.email as contact_email, shipper_locations.city, shipper_locations.address, shipper_locations.state, shipper_locations.country, shipper_locations.loc_type, (SELECT id FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id ORDER BY lane_priority DESC, created_at DESC LIMIT 1) AS lane_id, (SELECT lane_destination FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id ORDER BY lane_priority DESC, created_at DESC LIMIT 1) as lane_destination, (SELECT lane_origin FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id ORDER BY lane_priority DESC, created_at DESC LIMIT 1) as lane_origin, (SELECT date_opened FROM activities WHERE activities.shipper_id = shippers.id ORDER BY created_at DESC LIMIT 1) as date_opened, CONCAT(relationship_owner_user.first_name, ' ', relationship_owner_user.last_name) as relationship_owner_name, CONCAT(shipper_contacts.first_name, ' ', shipper_contacts.last_name) as pdm_name, (SELECT created_at FROM audits WHERE ((auditable_type = 'Carrier' AND auditable_id IN (shippers.id)) OR (auditable_type = 'CarrierCompany' AND auditable_id IN (SELECT id FROM shipper_companies WHERE shipper_companies.shipper_id = shippers.id)) OR (auditable_type = 'CarrierContact' AND auditable_id IN (SELECT id FROM shipper_contacts WHERE shipper_contacts.shipper_id = shippers.id)) OR (auditable_type = 'CarrierLane' AND auditable_id IN (SELECT id FROM shipper_lanes WHERE shipper_lanes.shipper_id = shippers.id)) OR (auditable_type = 'CarrierLocation' AND auditable_id IN (SELECT id FROM shipper_locations WHERE shipper_locations.shipper_id = shippers.id)) OR (auditable_type = 'Activity' AND auditable_id IN (SELECT id FROM activities WHERE activities.shipper_id = shippers.id)) OR (auditable_type = 'Rate' AND auditable_id IN (SELECT id FROM rates WHERE rates.shipper_id = shippers.id)) OR (auditable_type = 'Reminder' AND auditable_id IN (SELECT id FROM reminders WHERE reminders.shipper_id = shippers.id))) ORDER BY created_at DESC LIMIT 1) AS last_activity_date, (SELECT campaign_name FROM activities WHERE shipper_id =  shippers.id ORDER BY created_at DESC LIMIT 1) AS campaign_name, (SELECT activity_type FROM activities WHERE shipper_id =  shippers.id ORDER BY created_at DESC LIMIT 1) AS activity_type, (SELECT status FROM activities WHERE shipper_id =  shippers.id ORDER BY created_at DESC LIMIT 1) AS activity_status").joins("INNER JOIN users AS relationship_owner_user ON relationship_owner_user.id = shippers.relationship_owner").joins("INNER JOIN shipper_locations ON shipper_locations.id = shippers.head_office").joins("INNER JOIN shipper_contacts ON shipper_contacts.id = shippers.pdm_id").limit(1)}
