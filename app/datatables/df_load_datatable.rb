    ...
    records.map do |record|
      {
        ...
        curr: record.curr.round,
        ttt: record.ttt.round,
        billing: record.billing.round,
        gm: record.gm.round,
        gmper: record.gmper.round,
        cust_sys: record.cust_sys.round,
        carr_sys: record.carr_sys.round,
        gross_margin: record.gross_margin.round,
