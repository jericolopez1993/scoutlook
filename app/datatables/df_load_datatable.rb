class DfLoadDatatable < AjaxDatatablesRails::ActiveRecord
  ...
  def view_columns
    ...
    @view_columns ||= {
      ...
      mileage: { source: "DfLoad.mileage" },
      ttt_rpm: { source: "DfLoad.ttt_rpm" },
      bill_rpm: { source: "DfLoad.bill_rpm" },
      gm: { source: "DfLoad.gm" },
    ...
    records.map do |record|
      {
        ...
        mileage: record.mileage.to_f.round,
        ttt_rpm: record.ttt_rpm,
        bill_rpm: record.bill_rpm,
